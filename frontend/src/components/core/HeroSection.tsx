            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
                ...
                <div className="mt-16 flex justify-center gap-8 opacity-40">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-500">Smart Search</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-pink-500 animate-pulse delay-300" />
                        <span className="text-xs text-gray-500">Instant Results</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse delay-700" />
